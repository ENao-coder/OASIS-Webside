  ...
  <div class="projects">
    <section class="hero">
      ...
      <div class="hero-content">
        <h1 class="hero-title">Explora Nuestros</h1>
        <h2 class="hero-subtitle-main">Proyectos Pioneros</h2>
        <p class="hero-subtitle-text">Innovación en Óptica y Fotónica</p>
      </div>
    </section>
        ...
        this.projects = [
          {
            ...
            status: 'Activo',
            image: new URL('@/assets/resources/project-1.jpg', import.meta.url).href
          }
        ]
      } finally {
        this.loading = false
...
@media (max-width: 480px) {
  ...
  .projects-gallery { padding: 60px 20px; }
